//write an openMP program to sort an array of n elements using both sequential and parallel merge sort (using the sections directive).Record and print the difference in execution time
